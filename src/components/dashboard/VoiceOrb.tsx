...
const VoiceOrb: React.FC<VoiceOrbProps> = ({ 
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      uniformsRef.current.morph.value += (targetMorph - uniformsRef.current.morph.value) * 0.1;
  ...
  useEffect(() => {
    if (isSessionActive && volumeLevel > 0) {
      uniformsRef.current.RGBr.value = 0.75 + volumeLevel * 0.25;
      uniformsRef.current.RGBg.value = 0.5 + volumeLevel * 0.5;
      uniformsRef.current.RGBb.value = 0.7 + volumeLevel * 0.3;
      uniformsRef.current.RGBm.value = 1.0 + volumeLevel * 2;
    } else {
      uniformsRef.current.RGBr.value = 0.75;
      uniformsRef.current.RGBg.value = 0.5;
      uniformsRef.current.RGBb.value = 0.7;
      uniformsRef.current.RGBm.value = 1.0;
    }
