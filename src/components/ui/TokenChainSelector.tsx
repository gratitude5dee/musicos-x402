  ...
  return (
    <div className={`flex flex-col space-y-2 ${className}`}>
      <div className="relative">
        ...
        {showChainSelector && (
          <div className="absolute top-full left-0 right-0 mt-1 border border-gray-200 rounded-lg bg-white shadow-lg z-10 max-h-60 overflow-y-auto animate-fade-in">
            {CHAINS.map((chain) => (
              <button
                key={chain.id}
